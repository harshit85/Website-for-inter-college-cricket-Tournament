...
XMLHttpRequestObject.send(null);
   ...
   <div class="brand">GPL-Gurukula Premier League</div>
    <div class="address-bar"><b>Feculty Of Engineering and  Technology |G.K.V Haridwar</b></div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">GPL</a>
            </div>
    ...
    <div class="container">
       ...
       <div class="row">
            <div class="box" style="">
                ...
                <div class="col-md-6">
                    <img class="img-responsive img-border-left" src="img/ab3.jpg" alt="">
                </div>
                <div class="col-md-6">
                   <h2 class="intro-text text-center">Bull Busters</h2>
					<hr>
...
{ 
  echo "  <tbody> <tr>
                  <td>",$row['regid'],"</td>
                  <td><button onclick=".'"'."getData(this,'player.php','targetdivision')".'"'."value=".'"',$row['regid'],'"'.">",$row['fullname'],"</button></td>
                  <td>",$row['branch'],"</td>
                  <td>",$row['batsman'],"</td>
                  <td>",$row['bowler'],"</td>
                </tr></tbody>";
